...
public partial class BandejaTransacciones : System.Web.UI.Page
{
    System.Timers.Timer T_RevisaEstatusProceso = new System.Timers.Timer();
    ...
    protected void ConstruyeGraficaPuntos() {
        ...
        {            
            ...
            for (int index = 0; index < 10; index++)
            {
                ...
                ValoresEjeX.Append("'" + "Suc " + (index + 1).ToString() + "'");
